(function($){
	...
	$.fn.showGpxTracks=function(){
		this.each(function(){
			var self=this
			var gpxurl=$(this).attr('src')
			var minheight=200;
			var infowidth=30;
			...
			loadGpx(gpxurl,function(e,r){
				...
				var ltlg=new google.maps.LatLng(r[0].lt,r[0].lg)
				map.setOptions({
					scrollwheel: true,
					draggable: true,
					panControl:true,
				...
				s+="[<a href='"+gpxurl+"' download>Download GPX</a>] (c)<a href='http://kanasys.com/gtech/'>kanasys.com</a>"
				f.html(s)
			});
		})
	}
